        ...
        <div class="col-md-12">
            <div class="card bg-gradient-dark">
                <div class="card-header border-0">
                    <h3 class="card-title">
                        <i class="fas fa-chart-area mr-1"></i> Traffic Overview (Last 7 Days)
                    </h3>
                </div>
                <div class="card-body">
    ...
    <div class="row mb-3">
        <div class="col-md-6">
            <div class="card card-primary card-outline">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-globe mr-1"></i> Top Referrers</h3>
                </div>
                <div class="card-body">
        ...
        <div class="col-md-6">
            <div class="card card-warning card-outline">
                <div class="card-header">
                    <h3 class="card-title"><i class="fas fa-fire mr-1"></i> Most Viewed Pages (All Time)</h3>
                </div>
                <div class="card-body">

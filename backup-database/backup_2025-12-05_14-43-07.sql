...
INSERT INTO `activity_logs` VALUES("1","1","Login","User logged in successfully","::1","2025-12-05 14:15:19");
...
INSERT INTO `projects` VALUES("1","1","Demo Projects","demo-projects","A brief explanation for testing the module.","","Intermediate","2 hours","<p>Admin, User</p>","<ol><li>Led red x2</li><li>Breadboard x1</li></ol>","<ol><li>Arduino IDE</li></ol>","<p>Ceci est une histoire de test pour valider l affichage du projet.</p>","http://freelance-addons.net","https://github.com/",NULL,"Yes","12","2025-01-01 12:00:00");
INSERT INTO `projects` VALUES("2","1","Smart Weather Station","smart-weather-station","Create your own local weather station using ESP32.","","Advanced","5 hours","<p>ZelTroN-2K3</p>","<ul><li>ESP32 Board</li><li>DHT22 Sensor</li><li>OLED Display</li></ul>","<ul><li>Visual Studio Code</li><li>PlatformIO</li></ul>","<p>In this project, we will build a connected weather station...</p>","#","https://github.com/",NULL,"Draft","42","2025-01-02 14:30:00");
INSERT INTO `projects` VALUES("3","1","Blinking LED for Beginners","blinking-led","The Hello World of hardware.","","Easy","30 mins","<p>Open Source Community</p>","<ul><li>Arduino Uno</li><li>LED Blue</li><li>Resistor 220ohm</li></ul>","<ul><li>Arduino IDE</li></ul>","<p>The classic blinking LED project to get started with electronics.</p>","#","#",NULL,"Draft","5","2025-01-03 09:15:00");
...
INSERT INTO `users` VALUES("1","admin","$2y$10$NvXliB5Opjrh4yczEFLkUu2kvwN566y7TeqpUcI.ArQBcYoBbXeIO","zeltron2k3@gmail.com","assets/img/avatar.png",NULL,"Admin",NULL,NULL,"2025-12-05 15:43:06","0");
...
INSERT INTO `visitor_analytics` VALUES("1","::1","/F.A.Blog-CMS-main/","http://localhost/F.A.Blog-CMS-main/install/done.php","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36","2025-12-05 14:12:21");
INSERT INTO `visitor_analytics` VALUES("2","::1","/F.A.Blog-CMS-main/project?name=demo-projects","http://localhost/F.A.Blog-CMS-main/","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36","2025-12-05 14:15:09");
INSERT INTO `visitor_analytics` VALUES("3","::1","/F.A.Blog-CMS-main/","http://localhost/F.A.Blog-CMS-main/project?name=demo-projects","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36","2025-12-05 14:15:12");
INSERT INTO `visitor_analytics` VALUES("4","::1","/F.A.Blog-CMS-main/login","http://localhost/F.A.Blog-CMS-main/","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36","2025-12-05 14:15:14");
INSERT INTO `visitor_analytics` VALUES("5","::1","/F.A.Blog-CMS-main/login","http://localhost/F.A.Blog-CMS-main/login","Mozilla/5.0 (Windows NT 10.0; Win64; x64) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/143.0.0.0 Safari/537.36","2025-12-05 14:15:19");
...
INSERT INTO `widgets` VALUES("3","The F.A Blog Spirit","html","<p data-path-to-node=\"2\">Welcome to the world of <b>F.A Blog</b>.</p><p data-path-to-node=\"3\">Here, we take the time to decipher, analyze, and share insights on [Your Topic]. Far from the online noise, this space is dedicated to quality and authenticity.</p><p data-path-to-node=\"4\">My goal? To provide you with content that inspires and sparks reflection. Whether you are here out of curiosity or passion, you are now part of the journey.</p><p data-path-to-node=\"5\"><b>Don t miss a thing:</b>\r\nSubscribe to our newsletter to get our best insights delivered straight to your inbox.</p><blockquote data-path-to-node=\"6\"><p data-path-to-node=\"6,0\"><i>\"Understanding today to better build tomorrow.\"</i></p></blockquote>\r\n",NULL,"Sidebar","Yes");
INSERT INTO `widgets` VALUES("4","Quiz Leaderboard (Top 10)","quiz_leaderboard",NULL,NULL,"Sidebar","No");
INSERT INTO `widgets` VALUES("5","FAQ Leaderboard","faq_leaderboard",NULL,NULL,"Sidebar","No");
INSERT INTO `widgets` VALUES("6","Slider Testimonials","testimonials",NULL,NULL,"Sidebar","No");
INSERT INTO `widgets` VALUES("7","Newsletter","newsletter",NULL,NULL,"Sidebar","No");

...
(5, 'Contact', 'contact', 'fas fa-envelope text-danger', 'Yes'),
(6, 'FAQ', 'faq', 'fas fa-question-circle text-success', 'Yes'),
(7, 'Quiz', 'quiz', 'fas fa-graduation-cap text-success', 'Yes'),
(8, 'Info', 'page?name=about', 'fas fa-info text-info', 'No'),
(9, 'Legal Notice', 'legal-notice', 'fas fa-balance-scale me-2 text-info', 'No'),
(10, 'Privacy Policy', 'privacy-policy', 'fas fa-user-shield me-2 text-info', 'No'),
(11, 'Newsletter', 'newsletter', 'fas fa-envelope text-danger', 'No'),
(12, 'Chats', 'chat', 'fab fa-whatsapp fa-lg text-success', 'Yes');
-- --------------------------------------------------------
